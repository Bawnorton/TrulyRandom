...
public interface GraphBuilder<T> {
    ...
    GraphElement build(T t, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes);
}
