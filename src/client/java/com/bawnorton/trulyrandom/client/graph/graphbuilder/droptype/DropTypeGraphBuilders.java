...
public class DropTypeGraphBuilders {
    ...
    private static GraphElement archaelogyGraphBuilder(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
        return new ItemElement(Items.BRUSH);
    }

    private static GraphElement blockGraphBuilder(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
    ...
    private static GraphElement literalBlockGraphBuilder(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
        LootTableIdentifier tableId = tableDrops.getLootTableId();
        Identifier sourceId = tableId.getSourceId();
        Block block = Registries.BLOCK.get(sourceId);
    ...
    public static void addSource(LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes, LootTableDrops source, GraphElement root) {
    ...
    public static void addDirect(LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes, LootTableDrops source, GraphElement root) {
    ...
    private static GraphElement chestGraphBuilder(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
        LootTableIdentifier tableId = tableDrops.getLootTableId();
        if(tableId.isReward()) {
    ...
    private static GraphElement dispenserGraphBuilder(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
        return new DispenserGraphElement(tableDrops.getLootTableId());
    }

    private static GraphElement entityGraphBuilder(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
        LootTableIdentifier tableId = tableDrops.getLootTableId();
        Identifier sourceId = tableId.getSourceId();
    ...
    private static GraphElement gameplayGraphBuilder(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
        LootTableIdentifier tableId = tableDrops.getLootTableId();
    ...
    private static GraphElement potGraphBuilder(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
        return new ItemElement(Items.DECORATED_POT);
    }

    private static GraphElement shearingGraphBuilder(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
        return new ItemElement(Items.SHEARS);
    }

    private static GraphElement spawnerGraphBuilder(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
    ...
    private interface ForwardingDropTypeGraphBuilder extends GraphBuilder<LootTableDrops> {
        ...
        GraphBuilder<LootTableDrops> get(LootTableDrops tableDrops, Set<RegistryKey<LootTable>> inspectedTables);

        @Override
        default GraphElement build(LootTableDrops tableDrops, LootTableTracker lootTracker, RecipeTracker recipeTracker, Set<RegistryKey<LootTable>> inspectedTables, Set<RegistryKey<Recipe<?>>> inspectedRecipes) {
