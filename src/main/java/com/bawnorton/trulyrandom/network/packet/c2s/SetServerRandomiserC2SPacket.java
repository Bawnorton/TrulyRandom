...
public record SetServerRandomiserC2SPacket(Modules modules) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, SetServerRandomiserC2SPacket> PACKET_CODEC = Modules.PACKET_CODEC.xmap(SetServerRandomiserC2SPacket::new, SetServerRandomiserC2SPacket::modules);
