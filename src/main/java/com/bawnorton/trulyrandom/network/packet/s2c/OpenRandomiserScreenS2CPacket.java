...
public record OpenRandomiserScreenS2CPacket(Modules modules) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, OpenRandomiserScreenS2CPacket> PACKET_CODEC = Modules.PACKET_CODEC.xmap(OpenRandomiserScreenS2CPacket::new, OpenRandomiserScreenS2CPacket::modules);
